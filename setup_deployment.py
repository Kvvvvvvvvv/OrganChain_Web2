#!/usr/bin/env python3
"""
One-click deployment setup for Organ Donor Chain
...
def main():
    """Main setup function"""
    print("🚀 Organ Donor Chain - One-Click Deployment Setup")
    print("=" * 60)
    ...
    if not run_command("pip install Flask Werkzeug python-dotenv", "Installing Python packages"):
        print("⚠️  Some packages might not be installed. Continuing anyway...")
